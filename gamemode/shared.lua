...
GM.RunnerS = "Citizen" -- Runner team in singular
GM.RunnerP = "Citizens" -- Runner team in plural
GM.DeathS = "Combine" -- Death team in plural
GM.DeathP = "Combine" -- Death team in singular
...
function GM:CreateTeams( )
	...
	team.SetUp( TEAM_RUN, self.RunnerS, Color( 20, 20, 200 ), true )
	team.SetSpawnPoint( TEAM_RUN, "info_player_counterterrorist" )
	team.SetClass( TEAM_RUN, { "runner" } )

	team.SetUp( TEAM_DEATH, self.DeathS, Color( 170, 20, 20 ), false )
